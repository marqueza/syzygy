...
Text = require 'lib.UI.popo.Text'
local Theme = {}

Theme.Button = {}
Theme.Button.draw = function(self)
  love.graphics.setColor(64, 64, 64, 0)
  if self.hot then love.graphics.setColor(96, 96, 96, 50) end
  if self.down then love.graphics.setColor(32, 32, 32, 50) end
  love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
  if self.selected then 
    --love.graphics.setColor(128, 32, 32, 50) 
...
Theme.Textarea.draw = function(self)
  ...
  if self.selection_index and self.index ~= self.selection_index then
    ...
    if self.selected then 
      love.graphics.setColor(64, 200, 200)
    else
      love.graphics.setColor(128,128,128)
    end
...
Theme.Frame.draw = function(self)
  ...
  love.graphics.rectangle('fill', self.x+10, self.y+10, self.w-10, self.h-10)
